...
import app.aacr.studypoint.pojo.FacultyInfo;
...
public class faculty extends Fragment {
    ...
    private TextInputEditText fullname,age,univercity,specification,securitycode;
    private View root;
                    ...
                    path.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) {
                                ...
                                FacultyInfo facultyInfo = new FacultyInfo(profile, name1, age1, gender, university1, specialization1, security_code1, Id_proof);
                                database.child(Completeyourprofile.mobile).setValue(facultyInfo).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
